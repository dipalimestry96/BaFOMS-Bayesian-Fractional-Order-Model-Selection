## Here we have calculated the 95% Prediction interval for population density by including 20 years future time points
...
set.seed(111) # for reproducibility of results
...
filename = paste0("95_per_Prediction_Interval_MATRIX_M1_", "116", ".txt")
write.table(PI_matrix_M1, filename, row.names = FALSE)


filename = paste0("95_per_Prediction_Interval_MATRIX_M", "1", "_", "116", ".txt")  
...
filename = paste0("95_Prediction_Interval_","M", "1", "_", "116(mode)", ".jpeg" )
...
filename = paste0("95_per_Prediction_Interval_MATRIX_M2_", "116", ".txt")
write.table(PI_matrix_M2, filename, row.names = FALSE)


filename = paste0("95_per_Prediction_Interval_MATRIX_M", "2", "_", "116", ".txt")  
PI_mat = as.matrix(read.table(filename, header = TRUE)) # 95% CI values and mean profile matrix reading
df = data.frame(t = t*100, PI_mat[,2], PI_mat[,1], PI_mat[,3]) # data frame for plotting
dff = data.frame(t_previous = t[1:n_previous]*100, N) 
dfff = data.frame(t_future = t[(n_previous+1):n]*100, N_future = PI_mat[(n_previous+1):n, 2], 
...
filename = paste0("95_Prediction_Interval_","M", "2", "_", "116", ".jpeg")
ggsave(filename, plot = p, width = 8, height = 6, dpi = 600) # to save plot
...
filename = paste0("95_per_Prediction_Interval_MATRIX_M3_", "116", ".txt")
write.table(PI_matrix_M3, filename, row.names = FALSE)


filename = paste0("95_per_Prediction_Interval_MATRIX_M", "3", "_", "116", ".txt")  
PI_mat = as.matrix(read.table(filename, header = TRUE)) # 95% CI values and mean profile matrix reading
df = data.frame(t = t*100, PI_mat[,2], PI_mat[,1], PI_mat[,3]) # data frame for plotting
dff = data.frame(t_previous = t[1:n_previous]*100, N) 
dfff = data.frame(t_future = t[(n_previous+1):n]*100, N_future = PI_mat[(n_previous+1):n, 2], 
...
filename = paste0("95_Prediction_Interval_","M", "3", "_", "116", ".jpeg")
ggsave(filename, plot = p, width = 8, height = 6, dpi = 600) # to save plot
...
filename = paste0("95_per_Prediction_Interval_MATRIX_M4_", "116", ".txt")
write.table(PI_matrix_M4, filename, row.names = FALSE)


filename = paste0("95_per_Prediction_Interval_MATRIX_M", "4", "_", "116", ".txt")  
PI_mat = as.matrix(read.table(filename, header = TRUE)) # 95% CI values and mean profile matrix reading
df = data.frame(t = t*100, PI_mat[,2], PI_mat[,1], PI_mat[,3]) # data frame for plotting
dff = data.frame(t_previous = t[1:n_previous]*100, N) 
dfff = data.frame(t_future = t[(n_previous+1):n]*100, N_future = PI_mat[(n_previous+1):n, 2], 
...
filename = paste0("95_Prediction_Interval_","M", "4", "_", "116", ".jpeg")
ggsave(filename, plot = p, width = 8, height = 6, dpi = 600) # to save plot
...
filename = paste0("95_per_Prediction_Interval_MATRIX_M5_", "116", ".txt")
write.table(PI_matrix_M5, filename, row.names = FALSE)


filename = paste0("95_per_Prediction_Interval_MATRIX_M", "5", "_", "116", ".txt")  
PI_mat = as.matrix(read.table(filename, header = TRUE)) # 95% CI values and mean profile matrix reading
df = data.frame(t = t*100, PI_mat[,2], PI_mat[,1], PI_mat[,3]) # data frame for plotting
dff = data.frame(t_previous = t[1:n_previous]*100, N) 
dfff = data.frame(t_future = t[(n_previous+1):n]*100, N_future = PI_mat[(n_previous+1):n, 2], 
...
filename = paste0("95_Prediction_Interval_","M", "5", "_", "116", ".jpeg")
ggsave(filename, plot = p, width = 8, height = 6, dpi = 600) # to save plot
...
filename = paste0("95_per_Prediction_Interval_MATRIX_M6_", "116", ".txt")
write.table(PI_matrix_M6, filename, row.names = FALSE)


filename = paste0("95_per_Prediction_Interval_MATRIX_M", "6", "_", "116", ".txt")  
PI_mat = as.matrix(read.table(filename, header = TRUE)) # 95% CI values and mean profile matrix reading
df = data.frame(t = t*100, PI_mat[,2], PI_mat[,1], PI_mat[,3]) # data frame for plotting
dff = data.frame(t_previous = t[1:n_previous]*100, N) 
dfff = data.frame(t_future = t[(n_previous+1):n]*100, N_future = PI_mat[(n_previous+1):n, 2], 
...
filename = paste0("95_Prediction_Interval_","M", "6", "_", "116", ".jpeg" )
ggsave(filename, plot = p, width = 8, height = 6, dpi = 600) # to save plot
