...
library(rgpdd)
data = subset(gpdd_data, MainID == 200)$Population   # population abundance
...
filename = paste0("95_per_Confidence_Interval_MATRIX_M1_", "200", ".txt")
write.table(CI_matrix_M1, filename, row.names = FALSE)


filename = paste0("95_per_Confidence_Interval_MATRIX_M", "1", "_", "200", ".txt")  
...
filename = paste0("95_Confidence_Interval_","M", "1", "_", "200(mode)", ".jpeg" )
...
filename = paste0("95_per_Confidence_Interval_MATRIX_M2_", "200", ".txt")
write.table(CI_matrix_M2, filename, row.names = FALSE)


filename = paste0("95_per_Confidence_Interval_MATRIX_M", "2", "_", "200", ".txt")  
CI_mat = as.matrix(read.table(filename, header = TRUE)) # 95% CI values and mean profile matrix reading
df = data.frame(t = t*100, CI_mat[,2], CI_mat[,1], CI_mat[,3]) # data frame for plotting
dff = data.frame(t = t*100, N) 
library(ggplot2)
...
p = ggplot(df, aes(x = t, y = CI_mat[,2])) +
  ...
  guides(color = guide_legend(override.aes = list(linetype = c(1, 0), shape = c(NA, 16))),
         shape = "none",
         fill = guide_legend(override.aes = list(alpha = 0.45)))
filename = paste0("95_Confidence_Interval_","M", "2", "_", "200(mode)", ".jpeg")
ggsave(filename, plot = p, width = 8, height = 6, dpi = 600) # to save plot
...
filename = paste0("95_per_Confidence_Interval_MATRIX_M3_", "200", ".txt")
write.table(CI_matrix_M3, filename, row.names = FALSE)


filename = paste0("95_per_Confidence_Interval_MATRIX_M", "3", "_", "200", ".txt")  
CI_mat = as.matrix(read.table(filename, header = TRUE)) # 95% CI values and mean profile matrix reading
df = data.frame(t = t*100, CI_mat[,2], CI_mat[,1], CI_mat[,3]) # data frame for plotting
dff = data.frame(t = t*100, N) 
library(ggplot2)
...
filename = paste0("95_Confidence_Interval_","M", "3", "_", "200(mode)", ".jpeg")
ggsave(filename, plot = p, width = 8, height = 6, dpi = 600) # to save plot
...
filename = paste0("95_per_Confidence_Interval_MATRIX_M4_", "200", ".txt")
write.table(CI_matrix_M4, filename, row.names = FALSE)


filename = paste0("95_per_Confidence_Interval_MATRIX_M", "4", "_", "200", ".txt")  
CI_mat = as.matrix(read.table(filename, header = TRUE)) # 95% CI values and mean profile matrix reading
df = data.frame(t = t*100, CI_mat[,2], CI_mat[,1], CI_mat[,3]) # data frame for plotting
dff = data.frame(t = t*100, N) 
library(ggplot2)
...
filename = paste0("95_Confidence_Interval_","M", "4", "_", "200(mode)", ".jpeg")
ggsave(filename, plot = p, width = 8, height = 6, dpi = 600) # to save plot
...
filename = paste0("95_per_Confidence_Interval_MATRIX_M5_", "200", ".txt")
write.table(CI_matrix_M5, filename, row.names = FALSE)


filename = paste0("95_per_Confidence_Interval_MATRIX_M", "5", "_", "200", ".txt")  
CI_mat = as.matrix(read.table(filename, header = TRUE)) # 95% CI values and mean profile matrix reading
df = data.frame(t = t*100, CI_mat[,2], CI_mat[,1], CI_mat[,3]) # data frame for plotting
dff = data.frame(t = t*100, N) 
library(ggplot2)
...
filename = paste0("95_Confidence_Interval_","M", "5", "_", "200(mode)", ".jpeg")
ggsave(filename, plot = p, width = 8, height = 6, dpi = 600) # to save plot
...
filename = paste0("95_per_Confidence_Interval_MATRIX_M6_", "200", ".txt")
write.table(CI_matrix_M6, filename, row.names = FALSE)


filename = paste0("95_per_Confidence_Interval_MATRIX_M", "6", "_", "200", ".txt")  
CI_mat = as.matrix(read.table(filename, header = TRUE)) # 95% CI values and mean profile matrix reading
df = data.frame(t = t*100, CI_mat[,2], CI_mat[,1], CI_mat[,3]) # data frame for plotting
dff = data.frame(t = t*100, N) 
library(ggplot2)
xlabel = "t (years): 1931-1981"
...
p = ggplot(df, aes(x = t, y = CI_mat[,2])) +
  ...
  guides(color = guide_legend(override.aes = list(linetype = c(1, 0), shape = c(NA, 16))),
         shape = "none",
         fill = guide_legend(override.aes = list(alpha = 0.45)))
filename = paste0("95_Confidence_Interval_","M", "6", "_", "200(mode)", ".jpeg" )
ggsave(filename, plot = p, width = 8, height = 6, dpi = 600) # to save plot
